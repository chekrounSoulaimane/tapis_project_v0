...
public class MotifServiceImpl extends Service {
    ...
    static private ProprieteService proprieteService;
    ...
    public static void getClient() {
        ...
        proprieteService = retrofit.create(ProprieteService.class);
    }
    ...
    public void updateMotif(Motif motifToUpdate, File file, Long id) {
        getClient();
        RequestBody requestFile = RequestBody.create(MediaType.parse("image/jpg"), file);
        MultipartBody.Part body = MultipartBody.Part.createFormData("file", file.getName(), requestFile);
        Log.i("id user motif ", String.valueOf(id));
        Log.i("mitif id", String.valueOf(motifToUpdate.getId()));
        Call<UserMotif> call = motifService.updateMotif(motifToUpdate.getId(), motifToUpdate.getLibelle(), body, id);
        Call<Void> call1 = proprieteService.update(motifToUpdate);
